...
//go:generate protoc -I ../../api/protos ../../api/protos/auth_service.proto --go_out=../../api/ --go-grpc_out=../../api/
//go:generate protoc -I ../../api/protos ../../api/protos/chat_service.proto --go_out=../../api/ --go-grpc_out=../../api/
